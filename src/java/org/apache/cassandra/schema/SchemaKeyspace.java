...
public final class SchemaKeyspace
{
    ...
    public static TableParams createTableParamsFromRow(UntypedResultSet.Row row)
    {
        return TableParams.builder()
                          ...
                          .dcLocalReadRepairChance(row.has("dclocal_read_repair_chance") ? row.getDouble("dclocal_read_repair_chance") : 0.0)
                          ...
                          .readRepairChance(row.has("read_repair_chance") ? row.getDouble("read_repair_chance") : 0.0)
